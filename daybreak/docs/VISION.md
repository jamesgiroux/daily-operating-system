...
| Bridge | MCP connects DailyOS to other tools and data sources | Integrations (Gong, REDACTED, Linear) |
...
**Integrations:** MCP data source connectors. Gong for transcripts. REDACTED for CRM data. Linear for project tracking. Any combination, any entity mode.
