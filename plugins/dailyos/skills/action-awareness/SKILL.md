...
```json
{
  ...
  "entity": "Nexus Analytics",
  "person": "Sarah Chen",
  "due_date": "2026-02-20",
  "status": "open",
  "source_meeting": "Nexus Analytics Weekly Sync - Feb 14",
...
**Do this:**
- "There are 3 open items for Nexus Analytics from the Feb 7 sync, including the pricing proposal that was due Tuesday."
...
"Got it — 'Send updated proposal to Sarah by Friday.' Want me to add this to the action tracker for Nexus Analytics?"
