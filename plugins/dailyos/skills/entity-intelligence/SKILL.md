...
4. If multiple partial matches, ask user to clarify: "Did you mean Accounts/Nexus Analytics or Accounts/Nexus AnalyticsIQ?"
...
1. **Silent loading.** Never announce "I'm loading entity intelligence for Nexus Analytics." Just have it ready.
2. **No redundant asks.** If the user says "How is Nexus Analytics doing?" and dashboard.json has the health status, answer from workspace data. Do not ask the user to tell you.
...
4. **Gap awareness.** If a file is missing or empty, note it internally. If the user asks about something in a missing file, explain the gap: "Nexus Analytics doesn't have stakeholders mapped yet. Would you like me to create a stakeholder map?"
