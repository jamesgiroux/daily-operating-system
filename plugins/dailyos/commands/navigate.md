...
- `/navigate Nexus Analytics stakeholders` — Map the full influence landscape for an entity
...
```markdown
<!-- internal-only -->
## Pre-Conversation Brief: David Park (CTO, Nexus Analytics)
...
Infocalcion informed by patterns is fine. Unsupported speculation is not.
