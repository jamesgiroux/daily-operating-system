...
1. Save this plan to Accounts/Nexus Analytics/renewal-plan-2026-q1.md
2. Create {N} actions in data/actions.json from the milestones
   ...
   - ... (list all)
3. Update Accounts/Nexus Analytics/intelligence.json with the plan's risk mitigations
