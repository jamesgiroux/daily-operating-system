<?php
/**
 * Person Hero inner-block server-side render (W2 L1 — DOS-484).
 *
 * Projects from envelope section(s): Facts (person identity + profile/story narrative).
...
if ( ! function_exists( 'dailyos_person_hero_render' ) ) {
	/**
	 * Render the Person Hero inner block.
	 *
	 ...
	 */
	function dailyos_person_hero_render( array $attributes, array $ctx = [] ): string {
		...
		$wrapper_attrs = function_exists( 'get_block_wrapper_attributes' )
			? get_block_wrapper_attributes(
				[
					'class'        => 'wp-block-dailyos-person-hero',
					'data-ds-tier' => 'pattern',
					'data-ds-name' => 'PersonHero',
				]
			)
			: 'class="wp-block-dailyos-person-hero"';
		...
		$out .= '<div class="dailyos-person-hero__body" data-dailyos-projection="person-hero" data-trust-band-source="n/a — operational shell"></div>';
		$out .= '</section>';
