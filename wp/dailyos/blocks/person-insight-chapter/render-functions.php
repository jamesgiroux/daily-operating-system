<?php
/**
 * Person Insight Chapter inner-block server-side render (W2 L1 — DOS-484).
 *
 * Projects from envelope section(s): Health (rhythm/dynamic factors).
...
if ( ! function_exists( 'dailyos_person_insight_chapter_render' ) ) {
	/**
	 * Render the Person Insight Chapter inner block.
	 *
	 ...
	 */
	function dailyos_person_insight_chapter_render( array $attributes, array $ctx = [] ): string {
		...
		$wrapper_attrs = function_exists( 'get_block_wrapper_attributes' )
			? get_block_wrapper_attributes(
				[
					'class'        => 'wp-block-dailyos-person-insight-chapter',
		...
		$out .= '<div class="dailyos-person-insight-chapter__body" data-dailyos-projection="person-insight-chapter" data-trust-band-source="Health.aggregate_band"></div>';
		$out .= '</section>';
