<?php
/**
 * Person Insight Chapter dynamic block render entrypoint (W2 L1 — DOS-484).
 *
 * Inner block under `dailyos/person-detail`. Projects from envelope
 * section(s): Health (rhythm/dynamic factors).
...
echo dailyos_person_insight_chapter_render( $attributes, $ctx );
