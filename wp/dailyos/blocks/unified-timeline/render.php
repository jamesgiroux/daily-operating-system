<?php
/**
 * Unified Timeline dynamic block render entrypoint (W2 L1 — DOS-484).
 *
 * Inner block under `dailyos/person-detail`. Projects from envelope
 * section(s): Record (Paginated<RecordEntry>) + MetadataProposals lifecycle.
...
echo dailyos_unified_timeline_render( $attributes, $ctx );
