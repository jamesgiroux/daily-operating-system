<?php
/**
 * The Work inner-block server-side render (W2 L1 — DOS-484).
 *
 * Projects from envelope section(s): Facts (attached-work refs).
...
if ( ! function_exists( 'dailyos_the_work_render' ) ) {
	 ...
	 */
	function dailyos_the_work_render( array $attributes, array $ctx = [] ): string {
		...
		$out .= '<div class="dailyos-the-work__body" data-dailyos-projection="the-work" data-trust-band-source="per-work-item"></div>';
		$out .= '</section>';
