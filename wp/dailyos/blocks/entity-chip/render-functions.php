 ...
 *
 * Generated by `pnpm dailyos:new-block --template simple entity-chip`.
...
if ( ! function_exists( 'dailyos_entity_chip_render' ) ) {
	...
	function dailyos_entity_chip_render( array $attributes ): string {
		...
		if ( '' === $composition_id ) {
			return '<div class="wp-block-dailyos-entity-chip is-empty">'
	...
	function dailyos_entity_chip_render_from_projection( $response, array $attributes ): string {
		...
		$wrapper_attrs = function_exists( 'get_block_wrapper_attributes' )
			? get_block_wrapper_attributes(
				[
					'class'        => 'wp-block-dailyos-entity-chip',
		...
		foreach ( $blocks as $block ) {
			...
			$out .= '<article class="dailyos-block dailyos-block-entity-chip">';
