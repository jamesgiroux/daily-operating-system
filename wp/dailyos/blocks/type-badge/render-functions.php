 ...
 *
 * Generated by `pnpm dailyos:new-block --template simple type-badge`.
...
if ( ! function_exists( 'dailyos_type_badge_render' ) ) {
	...
	function dailyos_type_badge_render( array $attributes ): string {
		...
		if ( '' === $composition_id ) {
			return '<div class="wp-block-dailyos-type-badge is-empty">'
	...
	function dailyos_type_badge_render_from_projection( $response, array $attributes ): string {
		...
		$wrapper_attrs = function_exists( 'get_block_wrapper_attributes' )
			? get_block_wrapper_attributes(
				[
					'class'        => 'wp-block-dailyos-type-badge',
		...
		foreach ( $blocks as $block ) {
			...
			$out .= '<article class="dailyos-block dailyos-block-type-badge">';
