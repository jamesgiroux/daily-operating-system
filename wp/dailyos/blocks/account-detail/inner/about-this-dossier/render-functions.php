<?php
/**
 * About This Dossier (about-this-dossier) — W2 L1 inner block render-functions.
 *
 * Projection rule: Facts (dossier-about narrative) + envelope-level EnvelopeProvenance.
 *
...
if ( ! function_exists( 'dailyos_about_this_dossier_render' ) ) {
	/**
	 * Render the about-this-dossier inner block.
	 *
	 ...
	 * @return string
	 */
	function dailyos_about_this_dossier_render( array $attributes, string $content = '', $block = null ): string {
...
if ( ! function_exists( 'dailyos_about_this_dossier_select_claim_refs' ) ) {
	/**
	 * Select claim references from the envelope for the about-this-dossier projection.
	 ...
	 */
	function dailyos_about_this_dossier_select_claim_refs( ?array $envelope ): array {
		if ( null === $envelope ) {
			return [];
		}
		$refs = [];
...
if ( ! function_exists( 'dailyos_about_this_dossier_render_row' ) ) {
	/**
	 * Render a single claim row inside the about-this-dossier projection.
