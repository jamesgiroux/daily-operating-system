...
if ( ! function_exists( 'dailyos_touchpoints_feed_select_claim_refs' ) ) {
	/**
	 ...
	 */
	function dailyos_touchpoints_feed_select_claim_refs( ?array $envelope ): array {
		if ( null === $envelope ) {
			return [];
		}
		$refs = [];
...
if ( ! function_exists( 'dailyos_touchpoints_feed_render_row' ) ) {
	/**
