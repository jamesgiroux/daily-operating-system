<?php
/**
 * Watch List inner-block server-side render (W2 L1 — DOS-484).
 *
 * Projects from envelope section(s): OpenLoops (watch-list subset).
...
if ( ! function_exists( 'dailyos_watch_list_render' ) ) {
	 ...
	 */
	function dailyos_watch_list_render( array $attributes, array $ctx = [] ): string {
		...
		$out .= '<div class="dailyos-watch-list__body" data-dailyos-projection="watch-list" data-trust-band-source="per-loop"></div>';
		$out .= '</section>';
