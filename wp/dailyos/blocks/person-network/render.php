<?php
/**
 * Person Network dynamic block render entrypoint (W2 L1 — DOS-484).
 *
 * Inner block under `dailyos/person-detail`. Projects from envelope
 * section(s): Facts (network refs to accounts/projects/people).
...
echo dailyos_person_network_render( $attributes, $ctx );
