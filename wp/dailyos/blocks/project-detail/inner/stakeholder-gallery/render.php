<?php
/**
 * Stakeholder Gallery (stakeholder-gallery) dynamic block render entrypoint (W2 L1 inner block).
 *
...
echo dailyos_stakeholder_gallery_render( $attributes, $content, $block );
