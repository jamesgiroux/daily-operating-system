<?php
/**
 * Trajectory Chapter (trajectory-chapter) dynamic block render entrypoint (W2 L1 inner block).
 *
...
echo dailyos_trajectory_chapter_render( $attributes, $content, $block );
