 ...
 *
 * Generated by `pnpm dailyos:new-block --template simple {{BLOCK_NAME}}`.
...
if ( ! function_exists( 'dailyos_{{PHP_FUNCTION_PREFIX}}_render' ) ) {
	...
	function dailyos_{{PHP_FUNCTION_PREFIX}}_render( array $attributes ): string {
		...
		if ( '' === $composition_id ) {
			return '<div class="wp-block-dailyos-{{BLOCK_NAME}} is-empty">'
	...
	function dailyos_{{PHP_FUNCTION_PREFIX}}_render_from_projection( $response, array $attributes ): string {
		...
		$wrapper_attrs = function_exists( 'get_block_wrapper_attributes' )
			? get_block_wrapper_attributes(
				[
					'class'        => 'wp-block-dailyos-{{BLOCK_NAME}}',
		...
		foreach ( $blocks as $block ) {
			...
			$out .= '<article class="dailyos-block dailyos-block-{{BLOCK_NAME}}">';
