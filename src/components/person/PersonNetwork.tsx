...
const STAKEHOLDER_ROLES = [
  ...
  { stored: "technical_buyer", label: "Technical Buyer", bg: "var(--color-person-14)", fg: "var(--color-person)" },
  { stored: "primary_user", label: "Primary User", bg: "var(--color-person-14)", fg: "var(--color-person)" },
  { stored: "technical_user", label: "Technical User", bg: "var(--color-person-14)", fg: "var(--color-person)" },
