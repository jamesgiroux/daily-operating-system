/**
 * StakeholderGallery — Chapter 3: The Room.
 ...
 * Includes a "Your Team" strip showing internal account team members.
 */
...
const engagementBadgeStyles: Record<string, { background: string; color: string }> = {
  ...
  high: {
    background: "rgba(126, 170, 123, 0.14)",
  ...
  low: {
    background: "rgba(196, 101, 74, 0.10)",
  ...
  return (
    <section id="the-room" style={{ scrollMarginTop: 60, paddingTop: 80 }}>
      ...
      {hasStakeholders ? (
                  ...
                  {s.engagement && (
                    <span
                      style={{
                        ...
                        padding: "2px 7px",
                        borderRadius: 3,
                        ...(engagementBadgeStyles[s.engagement.toLowerCase()] ??
                          defaultBadgeStyle),
                      }}
                    >
                      {s.engagement}
        ...
        >
          No people linked to this account yet.
        </p>
      )}
