...
const ACTION_DETAIL_SURFACE_ATTRS = {
...
export default function ActionDetailPage() {
  ...
  if (loading) {
    return (
      <div className={`editorial-loading ${s.root} ${s.loadingSkeleton}`} {...ACTION_DETAIL_SURFACE_ATTRS}>
  ...
  if (error || !detail) {
    return (
      <div className={`${s.root} ${s.errorState}`} {...ACTION_DETAIL_SURFACE_ATTRS}>
  ...
  return (
    <div className={s.root} {...ACTION_DETAIL_SURFACE_ATTRS}>
        ...
        <div className={s.titleBand}>
          ...
          <button
            ...
            data-status={isCompleted ? "completed" : "open"}
            data-priority={detail.priority}
            data-busy={toggling ? "true" : "false"}
        ...
        <div className={s.section}>
          ...
          <div className={s.refSection}>
            ...
            <div className={s.refRow}>
              ...
              <div className={`${s.refValue} ${s.dueValue}`} data-urgency={dueUrgency}>
                <EditableDate
              ...
              <div className={s.refSection}>
                <div className={s.refRow}>
                  ...
                  <div className={s.refValue}>
                    ...
                    >
                      {detail.linearIdentifier}
                      <ExternalLink size={12} className={s.externalLinkIcon} />
                    </a>
                  </div>
                </div>
              </div>
