...
export default function AccountDetailPage() {
  ...
  const renderWorkView = () => {
    ...
    // string for "Linear"/"REDACTED"/etc. generated false Shared labels
      ...
      <>
        ...
        <MarginSection id="shared" label={<>Shared<br/>with<br/>team</>}>
          ...
          <EditorialEmpty
            ...
            message="Tracker integrations (Linear, REDACTED, Slack) land in v1.2.2 — DOS-75. Once wired, commitments with a real external link will appear here, with live writeback status."
          />
        </MarginSection>
