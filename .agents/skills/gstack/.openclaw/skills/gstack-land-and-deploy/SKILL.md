...
[ -f Procfile ] && echo "PLATFORM:cloudco"
...
# CloudCo: cloudco releases --app {app} -n 1 2>/dev/null
...
### Strategy B: Platform CLI (Fly.io, Render, CloudCo)
...
**CloudCo:** Check latest release:
```bash
cloudco releases --app {app} -n 1 2>/dev/null
```
