...
VALUES
    ('meeting-b12-revoked-source', 'Revoked Source Review', 'external', '2026-05-09T15:00:00Z', '2026-05-09T15:30:00Z', '["casey@revoked-source.example.com"]', '2026-05-04T09:00:00Z');

INSERT INTO people (id, email, name)
VALUES
    ('person-b12-casey', 'casey@revoked-source.example.com', 'Casey Chen');

INSERT INTO meeting_attendees (meeting_id, person_id)
VALUES
    ('meeting-b12-revoked-source', 'person-b12-casey');

INSERT INTO entities (id, name, entity_type, tracker_path, updated_at)
VALUES
    ('acct-b12-revoked', 'Revoked Account Example', 'account', NULL, '2026-05-04T09:00:00Z');

INSERT INTO meeting_entities (meeting_id, entity_id, entity_type, confidence, is_primary)
VALUES
    ('meeting-b12-revoked-source', 'acct-b12-revoked', 'account', 0.95, 1);
...
VALUES
    ('src-b12-revoked', '{"id":"acct-b12-revoked","kind":"account"}', 'meeting_topic', 'summary', NULL, 'Revoked Account Example is ready to approve the launch.', 'dedup-src-b12-revoked', 'hash-src-b12-revoked', 'agent:fixture', 'glean', 'meeting-b12-revoked-source', '2026-05-04T09:30:00Z', '2026-05-04T09:30:00Z', '2026-05-04T09:30:00Z', '{}', NULL, 'withdrawn', 'active', NULL, NULL, NULL, NULL, NULL, 0.93, NULL, NULL, NULL, 'state', 'internal', 'active', NULL, NULL);
