...
VALUES
    ('meeting-b11-stale-glean', 'Stale Account Check-in', 'external', '2026-05-08T13:00:00Z', '2026-05-08T13:30:00Z', '["taylor@stale-account.example.com"]', '2026-05-05T10:00:00Z');

INSERT INTO people (id, email, name)
VALUES
    ('person-b11-taylor', 'taylor@stale-account.example.com', 'Taylor Tran');

INSERT INTO meeting_attendees (meeting_id, person_id)
VALUES
    ('meeting-b11-stale-glean', 'person-b11-taylor');

INSERT INTO entities (id, name, entity_type, tracker_path, updated_at)
VALUES
    ('acct-b11-stale', 'Stale Account Example', 'account', NULL, '2026-05-05T10:00:00Z');

INSERT INTO meeting_entities (meeting_id, entity_id, entity_type, confidence, is_primary)
VALUES
    ('meeting-b11-stale-glean', 'acct-b11-stale', 'account', 0.95, 1);
...
VALUES
    ('src-b11-stale-glean', '{"id":"acct-b11-stale","kind":"account"}', 'meeting_topic', 'summary', NULL, 'Stale Account Example may still be blocked by the 2025 implementation risk.', 'dedup-src-b11-stale-glean', 'hash-src-b11-stale-glean', 'agent:fixture', 'glean', 'meeting-b11-stale-glean', '2025-03-01T10:00:00Z', '2025-03-01T10:00:00Z', '2025-03-01T10:00:00Z', '{}', NULL, 'active', 'active', NULL, NULL, NULL, NULL, NULL, 0.82, NULL, NULL, NULL, 'state', 'internal', 'active', NULL, NULL);
