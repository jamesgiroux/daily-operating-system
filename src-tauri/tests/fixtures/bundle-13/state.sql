...
VALUES
    ('meeting-b13-subject-bleed', 'Target Example Prep', 'external', '2026-05-10T17:00:00Z', '2026-05-10T17:30:00Z', '["alex@target.example.com"]', '2026-05-05T09:00:00Z');

INSERT INTO people (id, email, name)
VALUES
    ('person-b13-alex', 'alex@target.example.com', 'Alex Adams');

INSERT INTO meeting_attendees (meeting_id, person_id)
VALUES
    ('meeting-b13-subject-bleed', 'person-b13-alex');

INSERT INTO entities (id, name, entity_type, tracker_path, updated_at)
VALUES
    ('dos287-target-example', 'Target Example', 'account', NULL, '2026-05-05T09:00:00Z');

INSERT INTO meeting_entities (meeting_id, entity_id, entity_type, confidence, is_primary)
VALUES
    ('meeting-b13-subject-bleed', 'dos287-target-example', 'account', 0.95, 1);
...
VALUES
    ('src-b13-target', '{"id":"dos287-target-example","kind":"account"}', 'meeting_topic', 'summary', NULL, 'Target Example wants to confirm rollout owner and next decision.', 'dedup-src-b13-target', 'hash-src-b13-target', 'agent:fixture', 'user', 'meeting-b13-subject-bleed', '2026-05-05T09:30:00Z', '2026-05-05T09:30:00Z', '2026-05-05T09:30:00Z', '{}', NULL, 'active', 'active', NULL, NULL, NULL, NULL, NULL, 0.94, NULL, NULL, NULL, 'state', 'internal', 'active', NULL, NULL),
    ('src-b13-adjacent', '{"id":"dos287-adjacent-example","kind":"account"}', 'meeting_topic', 'summary', NULL, 'Adjacent Example has an unrelated infrastructure escalation.', 'dedup-src-b13-adjacent', 'hash-src-b13-adjacent', 'agent:fixture', 'user', 'meeting-b13-subject-bleed', '2026-05-05T10:30:00Z', '2026-05-05T10:30:00Z', '2026-05-05T10:30:00Z', '{}', NULL, 'active', 'active', NULL, NULL, NULL, NULL, NULL, 0.94, NULL, NULL, NULL, 'state', 'internal', 'active', NULL, NULL);
