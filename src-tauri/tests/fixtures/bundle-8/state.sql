...
INSERT INTO people (
    ...
    'acme.example.com', 'Internal stakeholder', 'internal',
    '2026-04-30T12:00:00Z', '2026-05-01T12:00:00Z',
...
INSERT INTO account_stakeholders (
    ...
    'acct-test-1', 'person-test-jane-doe', 'internal_stakeholder', 'stakeholder',
...
(
    'src-test-source-public',
    'acct-test-1',
    'executiveAssessment',
    'public_statement',
    'account_fact',
    'acct-test-1 has stated their goal is to publish a reusable onboarding guide for acme.example.com.',
    '2026-04-28T12:00:00Z',
    '{"source_id":"src-test-source-public","source_asof":"2026-04-28T12:00:00Z","lifecycle_state":"active","sensitivity":"public","surface_class":"public"}',
    '2026-04-28T12:00:00Z'
),
(
    'src-test-source-private',
    'acct-test-1',
    'internalStakeholderConcern',
    'internal_note',
    'stakeholder_note',
    'Internal stakeholder jane.doe@example.com is concerned about unmanaged beta escalations.',
    '2026-04-30T12:00:00Z',
    '{"source_id":"src-test-source-private","source_asof":"2026-04-30T12:00:00Z","lifecycle_state":"active","sensitivity":"confidential","surface_class":"private"}',
    '2026-04-30T12:00:00Z'
);
...
INSERT INTO signal_weights (
    ...
    ('public_statement', 'account', 'source_reliability', 0.90, 0.10, 1, '2026-05-01T12:00:00Z'),
    ('internal_note', 'account', 'source_reliability', 0.95, 0.05, 1, '2026-05-01T12:00:00Z'),
    ('provider_completion', 'account', 'enrichment_quality', 0.20, 0.80, 1, '2026-05-01T12:00:00Z');
...
(
    'claim-test-public-stated-goal',
    '{"kind":"account","id":"acct-test-1"}',
    'entity_summary',
    'executiveAssessment',
    'acct-test-1:public_goal:onboarding-guide',
    'acct-test-1 has stated their goal is to publish a reusable onboarding guide for acme.example.com.',
    'acct-test-1|entity_summary|executiveAssessment|public-goal-onboarding-guide|src-test-source-public',
    'sha256:bundle-8-public-stated-goal',
    'system:fixture',
    'public_statement',
    '{"source_id":"src-test-source-public","source_system":"public_statement","lifecycle_state":"active","sensitivity":"public","surface_class":"public"}',
    '2026-04-28T12:00:00Z',
    '2026-04-28T12:00:00Z',
    '2026-04-28T12:00:00Z',
    '{"sources":["src-test-source-public"],"source_asof":"2026-04-28T12:00:00Z","lifecycle_state":"active","sensitivity":"public","surface_class":"public"}',
    '{"fixture_bundle":8,"ground_truth":true,"source_lifecycle_state":"active","surface_class":"public"}',
    'active',
    'active',
    0.90,
...
(
    ...
    'stakeholder_insight',
    'internalStakeholderConcern',
    'acct-test-1:internal_stakeholder_concern:beta-escalations',
    'Internal stakeholder jane.doe@example.com is concerned about unmanaged beta escalations.',
    'acct-test-1|stakeholder_insight|internalStakeholderConcern|beta-escalations|src-test-source-private',
    'sha256:bundle-8-private-stakeholder-concern',
    'system:fixture',
    'internal_note',
    '{"source_id":"src-test-source-private","source_system":"internal_note","lifecycle_state":"active","sensitivity":"confidential","surface_class":"private"}',
    '2026-04-30T12:00:00Z',
    '2026-04-30T12:00:00Z',
    '2026-04-30T12:00:00Z',
    '{"sources":["src-test-source-private"],"source_asof":"2026-04-30T12:00:00Z","lifecycle_state":"active","sensitivity":"confidential","surface_class":"private"}',
    '{"fixture_bundle":8,"ground_truth":true,"source_lifecycle_state":"active","surface_class":"private","actual_schema_sensitivity":"confidential"}',
    'active',
    'active',
    0.92,
    '2026-05-01T12:00:00Z',
