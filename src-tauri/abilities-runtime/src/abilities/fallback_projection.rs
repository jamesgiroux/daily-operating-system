...
const CLAIM_SUMMARY_FIELDS: &[FieldPolicy] = &[
    ...
    text_field("/items/*/body", ClaimSensitivity::Internal),
    text_field("/items/*/severity", ClaimSensitivity::Internal),
    text_field("/items/*/entity_name", ClaimSensitivity::Internal),
    text_field("/items/*/entity_type", ClaimSensitivity::Internal),
    text_field("/items/*/entity_id", ClaimSensitivity::Internal),
    ...
    text_field("/availability_label", ClaimSensitivity::Internal),
    text_field("/freshness_label", ClaimSensitivity::Internal),
    text_field("/integrity_label", ClaimSensitivity::Internal),
    text_field("/empty_state_text", ClaimSensitivity::Internal),
];
const EVIDENCE_LIST_FIELDS: &[FieldPolicy] = &[
    ...
    text_field("/items/*/claim_id", ClaimSensitivity::Internal),
    text_field("/items/*/claim_type", ClaimSensitivity::Internal),
    text_field("/items/*/assertion_text", ClaimSensitivity::Internal),
    text_field("/items/*/evidence_quote", ClaimSensitivity::Internal),
    text_field("/items/*/quote_exactness", ClaimSensitivity::Internal),
    text_field("/items/*/quote_redaction_policy", ClaimSensitivity::Internal),
    text_field("/items/*/source_label", ClaimSensitivity::Internal),
    text_field("/items/*/source_asof", ClaimSensitivity::Internal),
    text_field("/items/*/workspace_file_kind", ClaimSensitivity::Internal),
    text_field("/items/*/trust_band", ClaimSensitivity::Internal),
    text_field("/items/*/sensitivity", ClaimSensitivity::Internal),
    text_field("/items/*/redaction_state", ClaimSensitivity::Internal),
    text_field("/items/*/source_locator/type", ClaimSensitivity::Internal),
    number_field("/items/*/source_locator/start_char", ClaimSensitivity::Internal),
    number_field("/items/*/source_locator/end_char", ClaimSensitivity::Internal),
    bool_field("/items/*/feedback_allowed", ClaimSensitivity::Internal),
    text_field("/items/*/feedback_claim_id", ClaimSensitivity::Internal),
    text_field("/items/*/feedback_route", ClaimSensitivity::Internal),
...
const ACTION_LIST_FIELDS: &[FieldPolicy] = &[
    ...
    text_field("/items/*/status_label", ClaimSensitivity::Internal),
