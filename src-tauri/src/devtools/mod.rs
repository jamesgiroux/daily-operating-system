...
pub(crate) fn seed_database(db: &ActionDb) -> Result<(), String> {
    ...
    let enrichments: Vec<PersonEnrichment> = vec![
        ...
        PersonEnrichment {
            ...
            title_history: Some(r#"[{"title":"VP Product","company":"Globex Industries","startDate":"2021-06"},{"title":"Senior Product Manager","company":"REDACTED","startDate":"2017-01","endDate":"2021-05"}]"#),
