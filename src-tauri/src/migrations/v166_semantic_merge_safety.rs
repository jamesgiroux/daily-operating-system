...
pub(super) fn migrate_v166_semantic_merge_safety(conn: &Connection) -> Result<(), MigrationError> {
...
mod tests {
    ...
    fn migration_backfills_recoverable_qualifiers_and_marks_unknown_legacy_claims() {
        ...
        migrate_v166_semantic_merge_safety(&conn).expect("migration succeeds");
