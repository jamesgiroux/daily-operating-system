...
/// I651: Product classification from REDACTED via Glean.
...
/// I651: Individual product information from REDACTED.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
#[serde(rename_all = "camelCase")]
...
pub struct IntelligenceJson {
    ...
    /// I651: Product classification from REDACTED (Glean-only)
    #[serde(default, skip_serializing_if = "Option::is_none")]
