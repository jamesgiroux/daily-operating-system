    ...
    let task = tauri::async_runtime::spawn_blocking(move || -> Result<ReportRow, String> {
        ...
        let mut input = {
            ...
            match report_type_str.as_str() {
                ...
                "weekly_impact" => crate::reports::weekly_impact::gather_weekly_impact_input(workspace, db, ai_models)?,
                "monthly_wrapped" => crate::reports::monthly_wrapped::gather_monthly_wrapped_input(workspace, db, ai_models)?,
