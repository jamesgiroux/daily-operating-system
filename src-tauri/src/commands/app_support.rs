...
mod tests {
    ...
    fn audit_finds_cross_contamination_in_executive_assessment() {
        ...
        insert_customer_account(
            ...
            "REDACTED",
            "REDACTED Sharp",
            &["REDACTED.com", "vip2-REDACTED.com"],
            None,
            None,
            None,
        );
        set_executive_assessment(
            &db,
            "target",
            "WordPress VIP performance at vip2-REDACTED.com remains healthy.",
        );
    ...
    fn audit_aggregates_multiple_fields_for_one_account() {
        ...
        insert_customer_account(
            ...
            "Jane",
            &["jane.com"],
            Some("We work closely with vip2-REDACTED.com teams."),
            Some("Q2 program references REDACTED.com scaling."),
            None,
        );
        insert_customer_account(
            &db,
            "REDACTED",
            "REDACTED",
            &["REDACTED.com", "vip2-REDACTED.com", "REDACTED.com"],
            None,
            None,
            None,
        );
        set_executive_assessment(
            &db,
            "target",
            "Migration progress on vip2-REDACTED.com is stable.",
        );
