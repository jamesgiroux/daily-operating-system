...
mod tests {
    ...
    fn test_slug_to_entity_id() {
        assert_eq!(slug_to_entity_id("REDACTED", "account"), "REDACTED");
        assert_eq!(slug_to_entity_id("REDACTED-(REDACTED)", "account"), "REDACTED-REDACTED");
        ...
        assert_eq!(slug_to_entity_id("REDACTED (Digital Marketing)", "account"), "REDACTED-digital-marketing");
    }
}
