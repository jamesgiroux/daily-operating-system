...
- `crestview-media.com` → 4 BUs (REDACTED, Corporate Services B2B, Diversification, Enterprises)
...
- [ ] **Review Gustavo's Node.js/log analysis support ticket** - Owner: James - Due: Dec 18
  ...
  - **Source**: `Accounts/Nexus Analytics/02-Meetings/2025-12-15-summary-REDACTED-vip-sync.md`
...
| 12:00 PM | **Nexus Analytics Monthly** | **Customer** | See 04-1200-customer-REDACTED-prep.md |
...
├── 04-1200-customer-REDACTED-prep.md    # Customer meeting (FULL PREP)
...
if domain in ['REDACTED.com', 'hilton.com', 'crestview-media.com', 'REDACTED.com']:
