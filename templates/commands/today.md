...
- `crestview-media.com` → 4 BUs (Consumer Brands, Corporate Services B2B, Diversification, Enterprises)
...
- [ ] **Review Gustavo's Node.js/log analysis support ticket** - Owner: James - Due: Dec 18
  ...
  - **Source**: `Accounts/Nexus Analytics/02-Meetings/2025-12-15-summary-nielsen-vip-sync.md`
...
| 12:00 PM | **Nexus Analytics Monthly** | **Customer** | See 04-1200-customer-nielsen-prep.md |
...
if domain in ['salesforce.com', 'hilton.com', 'crestview-media.com', 'intuit.com']:
