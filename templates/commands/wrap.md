...
todays_completed_meetings = [
    {
        ...
        'prep_file': '_today/03-1000-customer-dataco-prep.md'
    },
    # ...
]
```
...
| CloudCo | 2:00 PM | ⚠️ In inbox | Process with /inbox-processing |
...
1. [ ] Send updated connector documentation to CloudCo
   Account: CloudCo | Due: Today | Source: Dec 15 meeting
...
- 'CloudCo avoided connector delay through proactive coordination'
...
| new.person@dataco.com | ➕ Created | Nexus Analytics Monthly |
...
2. CloudCo: Win - connector demo successful
   → Add to Recent Wins?
...
└── archive/
    └── 2026-01-08/                     # Today's archived files
        ├── 00-overview.md
        ├── 03-1000-customer-dataco-prep.md
        ├── 80-actions-due.md
        ├── 83-email-summary.md
        ├── 90-agenda-needed/
