...
KNOWN_PROJECTS = {
    'agentforce': {
        'title_keywords': ['agentforce', 'vip <> REDACTED', 'REDACTED connector'],
        'partner_domains': {'REDACTED.com', 'rtcamp.com'},
...
MULTI_BU_DOMAINS = {
    ...
    'crestview-media.com': {
        'parent': 'Crestview Media',
        'bus': ['Corporate-Services-B2B', 'BrandsCo', 'Diversification', 'Enterprises'],
        'default': 'Corporate-Services-B2B'
    },
    'quickware.com': {
        'parent': 'Infocalc',
        'bus': ['CreditCo', 'Infocalc'],
        'default': 'CreditCo'
    }
}
