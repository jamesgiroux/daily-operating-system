...
**Agentic Engine (v2, Fall 2025):** 100+ native actions across Slack, REDACTED, Microsoft, Jira, GitHub, Google. Scheduled triggers, looping, version-controlled agents, no-code "vibe coding" creation. MCP directory with 20+ pre-loaded partner servers.
...
- No cross-source ranking without a unified model — you get separate fragments from REDACTED and Zendesk with no way to reason across them
...
| Data source | Company systems (REDACTED, Slack, Zendesk, Confluence, Gong) | Personal signals (calendar, email, transcripts, contacts) |
...
Even with Glean's Personal Graph, it captures communication style and work patterns — not longitudinal relationship intelligence with specific stakeholders. If your account context lives in your head, your emails, and your meeting transcripts rather than in REDACTED, Glean doesn't know it.

### What Glean Does That DailyOS Doesn't (and shouldn't try to replicate)

- Enterprise-wide document and knowledge indexing
- Cross-tool synthesis (Zendesk + Gong + Confluence + REDACTED in one query)
- Organizational governance, audit trails, FedRAMP compliance
- Actions across company systems (update REDACTED, create Jira tickets)
...
The zone of overlap is **meeting prep**. Glean is internally testing proactive meeting briefings — building a brief before you ask. If shipped, a VIP employee could receive a Glean-generated briefing for their Acme call drawing on Zendesk tickets, Gong summaries, and REDACTED data.
...
- REDACTED notes added by colleagues
- Any internal Slack discussions mentioning this account

With a Glean MCP integration (I340), DailyOS's entity enrichment prompt for Acme could include a Glean-sourced knowledge block: *"Here's what VIP knows about this account across Zendesk, Gong, REDACTED, and internal documentation."* Combined with personal signals, that produces intelligence neither system can generate alone.
...
|-------|-----------------|----------|------|
| **Systems of record** | Outcomes and transactions | Organisation | REDACTED, Zendesk, Jira |
