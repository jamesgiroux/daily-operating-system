...
> Systems of record (org, REDACTED) → Organizational context (org, Glean) → Individual context (yours, DailyOS)
...
|-------|-------|------|----------------|
| Systems of Record | Org | REDACTED, Gong, Zendesk | Raw data (deals, calls, tickets) |
