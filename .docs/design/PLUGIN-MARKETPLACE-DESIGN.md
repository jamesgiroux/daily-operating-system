...
The briefing told Sarah her Nexus Analytics renewal is in 60 days and health just went yellow. The prep showed a champion transitioning roles. The action trail has two overdue commitments.
...
_archive/2026-01/           → Last 3 meeting summaries with Nexus Analytics
_archive/2026-02/           → Most recent call notes

data/actions.json           → Filtered for Nexus Analytics: 2 overdue items
data/emails.json            → Recent email signals from Nexus Analytics domain
```
...
```markdown
# Nexus Analytics — Risk Assessment
**Date:** February 17, 2026 | **Renewal:** April 18, 2026 (60 days)
**Health:** Yellow (declined from Green, Feb 3)

## Executive Summary

Nexus Analytics's renewal is at moderate risk. Three converging signals demand
...
| Apr 1 | Renewal presentation to Nexus Analytics | Sarah + VP |
```

**What loops back:**
- Risk report saved to `Accounts/Nexus Analytics/risk-report-2026-02.md`
...
A generic AI would ask "tell me about your relationship with Nexus Analytics." Then "what are the risks?" Then "who are the stakeholders?" Then "what's the renewal timeline?" Six rounds of context-building before you get a draft that's probably wrong. With the plugin, the workspace IS the context. One sentence → deliverable.
...
involvement. The third (Nexus Analytics, $450K) is the watch item — see below.
...
**Nexus Analytics ($450K, renewal April 18).** Health declined to Yellow.
...
| Nexus Analytics | $450K | Apr 18 | Medium | Champion + sponsor gap |
| 4 others | $1.8M | Mar-Apr | High | No flags |

**Q1 renewal forecast: 97% gross retention expected.** Nexus Analytics is the
swing factor between 97% and 95%.

## Ask

1. Executive engagement for the Nexus Analytics renewal — request a joint call
...
Nexus Analytics, Jan 28). Users with less than 500 documents report high
...
**Who raised it:**
- David Park, Nexus Analytics CFO (Jan QBR): "If my team can see project names
...
**Impact:** Blocks adoption at enterprise accounts. Nexus Analytics and two
...
|--------|---------|-----------|-----------|
| Sarah Chen | Nexus Analytics | Positive | "Actually finds what I'm looking for" |
| David Park | Nexus Analytics | Concerned | "Title leakage is a problem" |
...
What it does when you say "risk report on Nexus Analytics":
...
What it does when you say "build a success plan for Nexus Analytics":
...
5. Generates a capture report: "Processed: 4 actions created, 2 people updated, entity intelligence refreshed for Nexus Analytics and Acme"

**`/dailyos:enrich {entity}`** — The Research Engine

What it does when you say "go deeper on Nexus Analytics before the QBR":
...
**`entity-intelligence`** — Fires when any entity name is mentioned in conversation. Silently reads the entity's workspace directory and loads context. The user says "I'm thinking about the Nexus Analytics situation" and Claude already has Nexus Analytics's full context loaded — without being asked.
...
If there are high-priority items (a QBR today, overdue actions on an at-risk account, a renewal this week), the plugin can surface them: "You have a QBR with Nexus Analytics in 3 hours. Their health declined to Yellow and your champion is transitioning. Would you like me to draft talking points for the executive conversation?"
...
When a user is working on anything related to an entity, the action-awareness skill surfaces relevant overdue items. Not as a guilt mechanism (P1: Zero-Guilt), but as context: "Note: you have 2 overdue items for Nexus Analytics that might come up in the conversation."

### 5. Post-Meeting Processing

After a meeting appears on the calendar and a transcript or notes appear in `_inbox/`, the plugin can proactively offer to capture: "I see notes from your Nexus Analytics call. Want me to process them? I'll extract actions, update stakeholder intelligence, and archive the summary."
...
The enrich skill can notice when entity intelligence is stale — no meeting in 30+ days, no signal updates, approaching a milestone. It surfaces this quietly: "Nexus Analytics's intelligence was last updated 45 days ago and their renewal is in 60 days. Want me to run an enrichment pass?"
