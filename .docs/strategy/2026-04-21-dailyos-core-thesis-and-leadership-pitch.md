...
The enterprise AI stack is consolidating around two layers. Layer 1, systems of record (REDACTED, Workday, CRM). Layer 2, organisational context (Glean, Copilot's org-graph, Notion AI workspace search). Both are vendor-indexed, org-owned, and work well in principle.
...
**Rivalry:** Microsoft Copilot, Google Gemini workspace, REDACTED Einstein, OpenAI ChatGPT Enterprise, Notion AI, SuperHuman, the Karpathy-LLM-Wiki / GBrain / OpenClaw wave, plus whatever Apple ships next year.
