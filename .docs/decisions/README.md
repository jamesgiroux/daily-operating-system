...
| [0046](0046-entity-mode-architecture.md) | Entity-mode architecture with orthogonal integrations | Accepted (Kits/Intelligence sections superseded by [0079](0079-role-presets.md)) |
...
| [0051](0051-user-configurable-metadata-settings.md) | User-configurable metadata settings | Superseded by [0079](0079-role-presets.md) |
...
| [0063](0063-meeting-preview-context.md) | Meeting preview cards surface prep context | Accepted |
...
| [0068](0068-oauth-pkce-keychain-hardening.md) | OAuth PKCE + Keychain token hardening | Accepted |
| [0069](0069-radix-ui-standalone-packages.md) | Radix UI standalone packages (supersedes ADR-0060) | Accepted |
| [0070](0070-internal-team-entities.md) | Internal team entities via internal organization account | Accepted |
| [0071](0071-schema-migration-framework.md) | Schema migration framework — numbered SQL migrations, bootstrap detection, forward-compat guard | Accepted |
| [0072](0072-auto-updater-architecture.md) | Auto-updater — Ed25519 update signing, Apple code signing, GitHub Releases delivery | Accepted |
| [0073](0073-editorial-design-language.md) | Editorial design language — typography as architecture, warm restraint, breathing room | Accepted |
| [0074](0074-vector-search-entity-content.md) | Vector search for entity content — hybrid retrieval, per-paragraph chunking, snowflake-arctic-embed-s via ONNX | Accepted (model superseded by 0078) |
| [0075](0075-conversational-interface-architecture.md) | Conversational interface architecture — MCP-first chat, session memory, entity-focused queries | Accepted |
