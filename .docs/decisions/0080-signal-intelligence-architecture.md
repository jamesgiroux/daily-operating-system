...
A user demos Agentforce (a project) to Jefferson Advisors (a customer). The system:
- Can't connect the meeting to the Agentforce project (no project auto-matching)
- Resolves to REDACTED (parent company) via domain matching instead of the tagged project
- Pulls REDACTED Security intelligence instead of Agentforce context
