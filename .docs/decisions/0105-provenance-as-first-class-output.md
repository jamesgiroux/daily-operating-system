...
pub enum TrustReason {
    DirectlyFromStructuredSource,          // User-typed, REDACTED field, calendar event attribute
...
pub enum ScoringClass {
    /// Source contributes to numeric scoring (health, risk, etc.). Example: REDACTED field.
    Scoring,
