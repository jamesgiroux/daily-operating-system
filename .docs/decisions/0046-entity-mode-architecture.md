...
**Date:** 2026-02-07
**Status:** Accepted (Kits and Intelligence sections partially superseded by [ADR-0079](0079-role-presets.md))
...
Meanwhile, the integration ecosystem (Gong, REDACTED, Linear, Gainsight, Asana, Granola, Fathom, etc.) is orthogonal to how work is organized. Any transcript source works with any entity mode. Any CRM feeds account entities. Any task tool feeds project entities.
...
| CRM / relationship | REDACTED, Gainsight, HubSpot, Clay | Account entities |
...
2. "What tools do you use?" → Integration checklist (Gmail, Gong, REDACTED, Linear, etc.)
