...
├── dashboard.md
├── REDACTED/          ← BU (human-readable name, no numeric prefix)
...
- **AccountDetailPage**: breadcrumb for children (`Accounts > Crestview Media > REDACTED`), BU list section for parents, portfolio aggregate row (total ARR, worst health, nearest renewal, BU count)
