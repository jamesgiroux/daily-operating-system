<?php
/**
 * Person Relationships dynamic block render entrypoint (W2 L1 — DOS-484).
 *
 * Inner block under `dailyos/person-detail`. Projects from envelope
 * section(s): Facts (relationship narrative) + Touchpoints (per-relationship cadence).
...
echo dailyos_person_relationships_render( $attributes, $ctx );
