<?php
/**
 * Touchpoints Feed (touchpoints-feed) dynamic block render entrypoint (W2 L1 inner block).
 *
...
echo dailyos_project_detail_touchpoints_feed_render( $attributes, $content, $block );
