<?php
/**
 * Watch List Milestones (watch-list-milestones) dynamic block render entrypoint (W2 L1 inner block).
 *
...
echo dailyos_watch_list_milestones_render( $attributes, $content, $block );
