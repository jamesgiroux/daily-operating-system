<?php
/**
 * Linear Issues Chapter (linear-issues-chapter) dynamic block render entrypoint (W2 L1 inner block).
 *
...
echo dailyos_linear_issues_chapter_render( $attributes, $content, $block );
