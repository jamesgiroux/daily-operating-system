<?php
/**
 * Open Loops Feed (open-loops-feed) dynamic block render entrypoint (W2 L1 inner block).
 *
...
echo dailyos_project_detail_open_loops_feed_render( $attributes, $content, $block );
