...
9. Glean search results show: document title, source app (REDACTED, Zendesk, Gong, Confluence, etc.), snippet, and a link. Clicking a Glean result opens the source URL in the browser (not a DailyOS page — Glean documents don't have local detail pages).
