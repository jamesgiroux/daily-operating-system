...
- W5-A uses the next contiguous migration on the rebased branch: registered v268, filename `268_workspace_backfill_state.sql`.
...
- Migration v268 for resumable backfill run/item/operation state.
...
- `src-tauri/src/migrations/268_workspace_backfill_state.sql`
...
Migration v268 adds three tables.
