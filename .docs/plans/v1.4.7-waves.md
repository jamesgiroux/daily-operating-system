...
**Current branch checkpoint (2026-05-26):** MCP v2 implementation is functionally complete enough for W5-B mandatory validation. All 10 catalog tools are registered handlers on `codex/v1.4.7-mcp-v2`; W2/W3/W4 implementation slices have landed locally; DOS-481 host-selection eval and the DOS-482 mandatory e2e axes pass locally. Remaining before merge/release: rebase on `dev`, L2, release-gate axis, manual Claude Desktop dogfood, PR review, and Linear closure.
