...
2. Attendee domains → Crestview Media (0.80), Jefferson Advisors (0.80), REDACTED (0.80)
3. Keywords → Agentforce (0.55)
4. All candidates enter a HashMap, best wins by confidence

**Problem:** A Jefferson Advisors person at a Crestview Media meeting creates a 0.80 Jefferson Advisors candidate. A REDACTED person creates a 0.80 REDACTED candidate. These compete with Crestview Media B2B even though the meeting is clearly about Crestview Media.
...
- Attendees from Jefferson Advisors/REDACTED appear in The Room (they were invited) but don't leak entity intelligence
