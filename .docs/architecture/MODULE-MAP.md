...
> **Auto-generated:** 2026-05-02 by `.docs/generators/gen-module-map.sh`

**291** Rust files across **35** module directories and **44** standalone modules.
...
| `intelligence/` | 21 | 77 | Intelligence lifecycle, enrichment orchestration |
...
| `observability/` | 1 | 0 | DOS-210 W3-A: Observability module per ADR-0120. |
...
|--------|-------|-----------|---------|
| `accounts.rs` | 1692 | 10 | Account workspace file I/O (I72 / ADR-0047). |
...
| `executor.rs` | 1477 | 1 | Workflow execution engine |
...
| `state.rs` | 1809 | 13 | AppState — DB, PTY, config |
| `task_supervisor.rs` | 34 | 1 | — |
| `types.rs` | 3361 | 7 | Shared type definitions |
| `util.rs` | 1267 | 28 | — |
| `watcher.rs` | 880 | 1 | File watcher for _inbox/ directory |
...
| `db/` |     intelligence, entity, google_api, pub(crate) entity, pub(crate) types, types |
