...
Glean surfaces a **full account contact roster** from the org's CRM, support, and communication systems. Querying Glean for JHI (Janus Henderson Investors) returns 72 contacts with:
